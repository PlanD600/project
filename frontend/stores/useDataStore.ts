...
interface DataState {
    ...
    handleGlobalSearch: (query: string, currentUser: User | null) => { projects: Project[]; tasks: Task[]; comments: (Comment & { task: Task })[] };
...
// NOTE: handleGlobalSearch now requires currentUser to be passed in for reactivity safety.
export const useDataStore = create<DataState>()(
    devtools<DataState>((set, get) => ({
        ...initialState,
