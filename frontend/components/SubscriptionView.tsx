...
const SubscriptionView: React.FC = () => {
  ...
  if (!subscriptionInfo || !currentUser) {
    return <div>Loading...</div>;
  }
  try {
    const { handleGetSubscriptionInfo, handleCreateCheckoutSession, handleCreatePortalSession } = useDataStore();
    ...
    return <div className="text-danger">שגיאה בטעינת מנוי: {String(error)}</div>;
  }
};
