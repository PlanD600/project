    ...
    return (
      <div style={{ marginRight: level > 0 ? `${level * 20}px` : '0px' }} className="mt-4">
        <div className="flex items-start space-x-3 space-x-reverse">
          <Avatar user={comment.user} className="w-9 h-9 rounded-full mt-1" />
        ...
        {isReplying && (
          <div className="flex items-start space-x-3 space-x-reverse mt-3 pr-5">
            <Avatar user={currentUser} className="w-8 h-8 rounded-full" />
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4" onClick={onClose}>
      ...
      >
        ...
        <footer className="p-4 border-t border-dark bg-medium/50">
          {canComment ? (
            <div className="flex items-start space-x-3 space-x-reverse">
              <Avatar user={currentUser} className="w-9 h-9 rounded-full" />
