...
export const GuestManagementView: React.FC = () => {
  // Remove guests from useDataStore destructure
  ...
  const loadGuests = async () => {
    try {
      ...
      // setGuests([]); // This line was removed as per the edit hint
    } catch (error) {
  ...
  try {
    ...
    return <div className="text-danger">שגיאה בטעינת ניהול אורחים: {String(error)}</div>;
  }
}; 