...
import { useDataStore } from '../stores/useDataStore';import { Project } from '../types';
...
  const {
    organization, // 2. שליפת הארגון מה-store
    notifications,
...
            <div>
                {/* --- START: FINAL CHANGE --- */}
                {/* 3. הצגת שם הארגון במקום שם המשתמש */}
...
          <div className="flex items-center space-x-2">
            {/* ... שאר הכפתורים והאייקונים נשארים כפי שהם ... */}
